                        ...
                        <div class="modal" id="myModal">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    Si eliminas esta publicación no podrás recuperarla luego, ¿Estás seguro que deseas eliminarla?
                                </div>

                                <!-- Modal footer -->
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-sm btn-primary" data-dismiss="modal">Volver</button>
                                    <a class="btn btn-danger btn-sm" href="{{route('image.delete', ['id' => $image->id])}}">Eliminar Publicación</a>
                                </div>
